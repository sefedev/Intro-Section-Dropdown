...
const App = () => {
  ...
  const COMPANY_LIST = ["History", "Our Team", "Blog"]
            ...
            <ul className="flex-col justify-between items-center text-mediumGray">
              ...
              <li className="mb-4" onClick={handleCompanyClick}>
                ...
                >
                  <span>
                  Company
                  {companyOpen ? <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> : <svg
                    width="10"
                    height="6"
                    xmlns="http://www.w3.org/2000/svg"
                    className="ml-3"
